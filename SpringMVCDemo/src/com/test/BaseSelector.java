...
public class BaseSelector {
	...
	public static void main(String[] args) {
		...
		cri.setCommand("select * from users ");
		cri.createCriteria().andEqualTo("id", "1");
		// .andIn("day_code", days);
		cri.or(cri.createCriteria().andEqualTo("name", "111"));
//		cri.setOrderByClauseAsc("id");
//		cri.setOrderByClauseDesc("name");
